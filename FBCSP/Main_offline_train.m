...
% 构建到上级Data目录的路径
dataPath = fullfile(scriptDir, 'yun_merged_1_3.mat'); 
% dataPath = fullfile(scriptDir, 'CQQ_merged_1_4.mat'); 
load(dataPath);
X_train = double(data); % 训练集pre_A01.mat
Y_train = labels - 2 ;        % 训练集标签

% scriptDir = 'E:\桌面\BCI_Project\EEG_Data\pre_for_mat_data\yunyun';
% dataPath = fullfile(scriptDir, 'CQQ_newpre_test07.mat'); 
dataPath = fullfile(scriptDir, 'yun_newpre_test04.mat'); 
load(dataPath);
